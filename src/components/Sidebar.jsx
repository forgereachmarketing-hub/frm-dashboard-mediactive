...
const OUTREACH_ICON = <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
...
const NAV_ITEMS = [
  ...
  { key: 'outreach-ig',  label: 'Outreach — Instagram', icon: OUTREACH_ICON },
  { key: 'outreach-li',  label: 'Outreach — LinkedIn',  icon: OUTREACH_ICON },
